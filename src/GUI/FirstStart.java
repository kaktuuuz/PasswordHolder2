...
public class FirstStart extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Password Holder First Start");
        setAutoRequestFocus(false);
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setName("firstStart"); // NOI18N
        setResizable(false);

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Первый запуск программы Password Holder");

        jLabel2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setText("Введите новый пароль для входа в программу");

        tfPassword.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        ...
        tfPassword2.setFont(new java.awt.Font("Tahoma", 2, 11)); // NOI18N
        tfPassword2.setForeground(new java.awt.Color(204, 204, 204));
        tfPassword2.setText("Повторите пароль");
        tfPassword2.setName("tfPassword2"); // NOI18N
        tfPassword2.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tfPassword2FocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(tfPassword2, javax.swing.GroupLayout.PREFERRED_SIZE, 301, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tfPassword2FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tfPassword2FocusGained
        // TODO add your handling code here:
        GUIUtils.focusGained((JTextField) evt.getComponent());
    }//GEN-LAST:event_tfPassword2FocusGained
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(!tfPassword.getText().equals(tfPassword2.getText())){
           JOptionPane.showMessageDialog(this,"Пароли не совпадают");
            ...
            try {
                FileUtils.writeToFile(new MyBean("Password Holder", "PasswordHolderUser", tfPassword.getText(), "Пароль для входа в программу"));
                this.dispose();
